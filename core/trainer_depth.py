...
class Trainer:
    def __init__(self, config):
        ...
        self.train_loader = PrefetchDataLoader(
            self.train_args["num_prefetch_queue"], **dataloader_args
        )
        ...
        self.netG = net.RecurrentDepthCompleteNet()
        # print(self.netG)
    ...
    def load(self):
        ...
        if latest_epoch is not None:
            ...
            if self.config["global_rank"] == 0:
                print(
                    "Warning: There is no trained model found by trainer_depth.py\n"
    ...
    def _train_epoch(self, pbar):
        ...
        while train_data is not None:
            ...
            # complete flow
            pred_flows_bi, pred_edges_bi = self.netG.forward_bidirect_flow(
            ...
            if self.iteration % 200 == 0 and self.gen_writer is not None:
                ...
                self.gen_writer.add_image(
                    "img/flow-f:gt-pred", flow_results, self.iteration
                )
                ...
                self.gen_writer.add_image(
                    "img/flow-b:gt-pred", flow_results, self.iteration
                )
                ...
                self.gen_writer.add_image(
                    "img/edge-f:gt-pred", edge_results, self.iteration
                )
                # backward
                ...
                self.gen_writer.add_image(
                    "img/edge-b:gt-pred", edge_results, self.iteration
                )
