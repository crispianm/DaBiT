...
class Trainer:
    ...
    def load(self):
        ...
        if latest_epoch is not None:
            ...
            if self.config['global_rank'] == 0:
                print('Warnning: There is no trained model found by trainer_flow_w_edge.py\n'
    ...
    def _train_epoch(self, pbar):
        ...
        while train_data is not None:
            ...
            # complete flow
            pred_flows_bi, pred_edges_bi = self.netG.forward_bidirect_flow(gt_flows_bi, local_masks) #remove module, cm
